...
* **Núdzové vymazanie:** Troitým klepnutím okamžite vymažete všetky lokálne dáta.
...
* **Binárny protokol:** Kompaktný formát paketov optimalizovaný pre obmedzenia Bluetooth LE.
...
### Scenár použitia
Aplikácia je vyvinutá prioritne pre **krízovú komunikáciu** na vidieku v strednej Európe. V prípade, že nastane celkový **výpadok mobilnej siete** alebo kolaps elektrickej sítě, OfflineMessenger slúži pre **vidiecke obce** (napr. v rámci regiónu ako **Košický kraj**) ako masová používateľská komunikačná vrstva na koordináciu záchranných zložiek a obyvateľstva.
